...
None of the three exercises overturns the qualitative picture: the sign and the
rough magnitude of $\hat{\alpha}$ survive every perturbation we have tried. What
they do change is the precision one is entitled to claim. The twenty per cent
band around $K^{\star}$ is conditional on $\delta$, on constant returns, and on
a residual that is measured rather than inferred; loosening any one of the three
widens it, and loosening all three at once widens it enough that
Table~\ref{tab:estimates} is better read as a central case than as an interval.
