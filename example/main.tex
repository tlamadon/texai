...
file and not merely to the right line.
\end{abstract}
...
To make the test worth running, the document is long enough to spill over
...
The content below is deliberately ordinary economics: a production function, a
household problem, a panel of invented data, and the regressions one would run
on it. Ordinary is the point. A reviewer's attention should go to the mechanics
of selecting and rewriting passages, not to the argument, and any sentence here
